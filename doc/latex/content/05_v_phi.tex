...
v(\phi) = \frac{h}{a(1-e^2)} \left(1 + e\cos\left[\left(1 - \frac{3GM}{c^2a(1-e^2)} + \frac{9G^2M^2}{8c^4a^2(1-e^2)^2}\right)\phi + \alpha\phi^2\right]\right)
}\end{equation}
...
\begin{itemize}[leftmargin=*,noitemsep]
    ...
    \item $\alpha\phi^2$: Nichtlineare Bahnstörung (2. Ordnung)
\end{itemize}
