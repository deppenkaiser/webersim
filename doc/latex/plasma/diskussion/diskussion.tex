...
\begin{itemize}  
    \item \textbf{Stabilisierung von Fusionsplasmen}:\\Das Quantenpotential $Q = -\frac{\hbar^2}{2m_e} \frac{\nabla^2 \sqrt{\rho}}{\sqrt{\rho}}$ (Gl. \refeq{eq:quantenpotential}) modifiziert die Dispersionsrelation von Plasmawellen zu  
    \[
    ...
    \item \textbf{Anomale Transportphänomene}:\\Die direkten Weber-Kräfte (Gl. \refeq{eq:weber_em_vektor}) führen zu nicht-lokalen Korrelationen, die den \enquote{anomalen Widerstand} in Tokamaks ohne Turbulenzmodelle beschreiben. Experimente an ITER könnten hier entscheidende Daten liefern.
\end{itemize}  
