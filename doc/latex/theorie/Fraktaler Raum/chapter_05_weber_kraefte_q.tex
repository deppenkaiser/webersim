...
Die Weber-Kräfte (WG und WED) sind \emph{instantan}. Sie wirken direkt zwischen den Teilchen – sie sind eine Fernwirkung im Newtonschen Sinne, aber mit
geschwindigkeitsabhängiger Struktur (IIR-Rekursion). 
...
Die fraktale Energieverteilung (Kapitel 2) ist der \emph{zeitliche Mittelwert} der Q-Welle. Die \enquote{Löcher} sind die Minima der Q-Welle, die \enquote{Berge}
sind die Maxima.
