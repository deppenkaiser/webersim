...
Die fraktale Gewichtung der Quantenmechanik (Kapitel 6) führt zu einer charakteristischen Knotenstruktur, die den Ecken, Kanten und Flächen des Dodekaeders entspricht.

\subsection{Durchführung}

Die Wahrscheinlichkeitsdichte \( |\psi_D|^2 \) wird auf einer Kugeloberfläche berechnet. Die fraktal gewichteten Kugelflächenfunktionen werden für \( D \approx 2,704 \) numerisch ausgewertet.

\subsection{Erwartetes Ergebnis}

Die Maxima der Wahrscheinlichkeitsdichte liegen bei den 20 Ecken des Dodekaeders, die Minima bei den 12 Flächenzentren. Die Knotenlinien verlaufen entlang der 30 Kanten.
