...
\label{app:grundlagen}

\section{Einleitung}
\label{app:grundlagen_einleitung}
...
\label{app:grundlagen_varrechnung}

\subsection{Diskretes Funktional}
\label{app:grundlagen_funktional}
...
\label{app:grundlagen_variation}
...
\label{app:grundlagen_euler_lagrange}
...
\label{app:grundlagen_wellengleichung}
...
\label{app:grundlagen_noether}

\subsection{Symmetrien in diskreten Systemen}
\label{app:grundlagen_symmetrien}
...
\label{app:grundlagen_erhaltung}
...
\label{app:grundlagen_symmetrien_tabelle}
...
\label{app:grundlagen_metrik}

\subsection{Definition aus dem Funktional}
\label{app:grundlagen_metrik_def}
...
\label{app:grundlagen_metrik_kopplung}
...
\label{app:grundlagen_metrik_eigenschaften}
...
\label{app:grundlagen_fraktal}

\subsection{Fraktale Dimension eines diskreten Netzwerks}
\label{app:grundlagen_fraktale_dim}
...
\label{app:grundlagen_fraktale_berechnung}
...
\label{app:grundlagen_fraktales_netz}
...
\label{app:grundlagen_differenzengleichungen}

\subsection{Rekursive Update-Regeln}
\label{app:grundlagen_update}
...
\label{app:grundlagen_stabilitaet}
...
\label{app:grundlagen_weber_stabil}

Die diskrete Weber-Kraft (siehe Kapitel~\ref{ch:dstt_weber}) ist stabil für:
...
\label{app:grundlagen_fourier}

\subsection{Diskrete Fourier-Transformation}
\label{app:grundlagen_fourier_trans}
...
\label{app:grundlagen_dispersion}
...
\label{app:grundlagen_matrix}

\subsection{Laplace-Matrix}
\label{app:grundlagen_laplace}
...
\label{app:grundlagen_eigenwerte}
...
\label{app:grundlagen_zusammenfassung}
