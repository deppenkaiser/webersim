...
Dabei ist \( l_0 \approx 1,8 \times 10^{-15} \, \text{m} \) die fundamentale Längenskala (siehe Kapitel 10.2) und \( \rho_0 \) eine Normierungskonstante. Aus der stationären Kosmologie (Anhang J) folgt \( \rho_0 \sim 10^{-26} \, \text{kg/m}^3 \).
...
Wegen \( D-2 \approx -0,296 \) folgt \( H_{\text{eff}}(d) \propto d^{-0,296} \). Die absolute Normierung von \( H_{\text{eff}} \) wird durch \( \rho_0 \) bestimmt. Mit der beobachteten mittleren Dichte \( \rho_0 \sim 10^{-26} \, \text{kg/m}^3 \) ergibt sich \( H_0 \sim 70 \, \text{km/s/Mpc} \), konsistent mit Messungen.
