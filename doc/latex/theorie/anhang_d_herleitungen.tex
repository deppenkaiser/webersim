...
Dabei ist \( l_0 \approx 1,8 \times 10^{-15} \, \text{m} \) die fundamentale Längenskala (siehe Kapitel~\ref{ch:bec_objekte}) und \( \rho_0 \) eine Normierungskonstante. Aus der stationären Kosmologie (Anhang~\ref{app:materieentstehung}) folgt \( \rho_0 \sim 10^{-26} \, \text{kg/m}^3 \).

\subsection{Eingeschlossene Masse}
\label{sub:herleitungen_rot_masse}
...
\label{sub:herleitungen_rot_integration}
