...
(siehe Kapitel~\ref{ch:fraktale_dimension}).
...
Dies ist konsistent mit Kapitel~\ref{ch:fraktale_dimension}.
...
aber prinzipiell möglich macht (siehe Kapitel~\ref{ch:testbare_vorhersagen}).
...
über kosmische Distanzen bemerkbar machen (siehe Kapitel~\ref{ch:testbare_vorhersagen}).
