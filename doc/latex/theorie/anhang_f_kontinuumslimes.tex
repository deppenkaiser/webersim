...
\begin{enumerate}
    ...
    \item Die fraktale Dimension \( D \) manifestiert sich im Limes \emph{nicht} in der
          ...
          Skalierungsgesetzen (siehe Anhang~\ref{app:spektrale_dimension}).
\end{enumerate}
...
\label{app:kontinuumslimes_annahmen}
...
\label{app:kontinuumslimes_dodekaeder}
...
\begin{itemize}
    ...
    \item Die fraktale Struktur bleibt in der \emph{Zustandsdichte} und den
          \emph{Skalierungsgesetzen} erhalten (siehe Anhang~\ref{app:spektrale_dimension}).
...
\label{app:kontinuumslimes_grenzfeld}
...
\label{app:kontinuumslimes_konvergenz}
...
\label{app:kontinuumslimes_funktional}

\subsection{Diskretes Funktional in kontinuierlicher Notation}
\label{app:kontinuumslimes_funktional_diskret}

Das diskrete Funktional aus Anhang~\ref{app:grundlagen},
...
\label{app:kontinuumslimes_operatoren}
...
\label{app:kontinuumslimes_funktional_konv}
...
\label{app:kontinuumslimes_euler}

\subsection{Diskrete Euler-Lagrange-Gleichung}
\label{app:kontinuumslimes_euler_diskret}

Aus Anhang~\ref{app:grundlagen}:
...
\label{app:kontinuumslimes_euler_kont}
...
\label{app:kontinuumslimes_geschwindigkeit}
...
\label{app:kontinuumslimes_metrik}

\subsection{Diskrete Metrik als Approximation der euklidischen Metrik}
\label{app:kontinuumslimes_metrik_diskret}

Die diskrete Metrik ist definiert als (Anhang~\ref{app:grundlagen}):
...
\label{app:kontinuumslimes_metrik_eigenschaften}
...
\label{app:kontinuumslimes_grenzfall}
...
\label{app:kontinuumslimes_dodekaeder_netz}

\subsection{Definition des diskreten Netzwerks}
\label{app:kontinuumslimes_netz_def}
...
entsteht (siehe Kapitel~\ref{ch:fraktale_dimension}). Die Knotenanzahl nach \( N \) Iterationen ist:
...
\label{app:kontinuumslimes_einbettung}
...
\label{app:kontinuumslimes_operatoren_konv}
...
\label{app:kontinuumslimes_fraktale_rolle}
...
\label{app:kontinuumslimes_existenz}
...
\label{app:kontinuumslimes_welle_diskret}
...
\label{app:kontinuumslimes_welle_kont}
...
Skalierung der Lösungen (siehe Anhang~\ref{app:spektrale_dimension} für die Dispersionsrelation).
...
\begin{itemize}
    ...
    \item \textbf{Fraktale Struktur:} Bleibt in der Zustandsdichte und den Skalierungsgesetzen
          erhalten (siehe Anhang~\ref{app:spektrale_dimension})
\end{itemize}
