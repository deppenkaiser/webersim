...
Herleitung aus den Grundgleichungen der WG (siehe Kapitel~\ref{ch:dstt_weber}).
...
\label{app:periheldrehung_weber_kraft}

Für zwei Massen \( M \) (Zentralmasse) und \( m \) (Testmasse) lautet die 
Weber-Kraft (Kapitel~\ref{ch:dstt_weber}, Abschnitt 8.4.3):
...
\label{app:periheldrehung_bahnebene}
...
\label{app:periheldrehung_drehimpuls_exakt}
...
\label{app:periheldrehung_drehimpuls_ordnung}
...
\label{app:periheldrehung_beschleunigung}
...
\label{app:periheldrehung_radial_gleichung}
...
\label{app:periheldrehung_substitution}
...
\label{app:periheldrehung_einsetzen}
...
\label{app:periheldrehung_bahngleichung}
...
\label{app:periheldrehung_entwicklung}
...
\label{app:periheldrehung_drei_beitraege}
...
\label{app:periheldrehung_stoerung}
...
\label{app:periheldrehung_erste_ordnung}
...
\label{app:periheldrehung_stoerterm}
...
\label{app:periheldrehung_partikulaer}
...
\label{app:periheldrehung_gesamtloesung}
...
\label{app:periheldrehung_resonanz}
...
\label{app:periheldrehung_addition}
...
\label{app:periheldrehung_kappa}
...
\label{app:periheldrehung_perihel_umlauf}
...
\label{app:periheldrehung_formel}
...
\begin{itemize}
    ...
    \item Die Weber-Gravitation reproduziert dieses ART-Ergebnis 
          ...
          Wechselwirkung (siehe Kapitel~\ref{ch:dstt_weber}).
\end{itemize}
...
kompensiert (siehe Kapitel~\ref{ch:neutrino}), was die Bahnstabilität 
auf allen Skalen sicherstellt.

\section*{Hinweis zur numerischen Implementierung}
\label{app:periheldrehung_numerik}
...
Kapitel~\ref{ch:dstt_weber} (Abschnitt 8.4.5). Das Differentialgleichungssystem erster Ordnung
...
vergleichbar (siehe Anhang~\ref{app:numerik}).