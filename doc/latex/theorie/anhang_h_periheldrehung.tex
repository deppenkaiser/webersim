...
Herleitung aus den Grundgleichungen der WG (siehe Kapitel~\ref{ch:dstt_weber_kraefte}).
...
Weber-Kraft (Kapitel~\ref{ch:dstt_weber_kraefte}):
...
bestimmt. Die vollständige Post-Newtonsche Entwicklung (siehe \cite{WillNordtvedt1972}) 
für eine Kraft vom Weber-Typ liefert nach Mittelung über schnelle Oszillationen:
...
\begin{itemize}
    ...
    \item Die Weber-Gravitation reproduziert dieses ART-Ergebnis 
          ...
          Wechselwirkung (siehe Kapitel~\ref{ch:dstt_weber_kraefte}).
\end{itemize}
...
Kapitel~\ref{ch:dstt_weber_kraefte}. Das Differentialgleichungssystem erster Ordnung
