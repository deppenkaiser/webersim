...
\[
\rho_{\text{states}}(\omega) = \frac{D}{2\pi^2} \frac{\omega^{D-1}}{c^D} \Gamma(D/2) \tag{I.1}
\]
...
\hbar \omega \, \rho_{\text{states}}(\omega) \, d\omega \tag{I.2}
\]
...
\cdot \frac{c^{3-D}}{l_0^{D+1}} \tag{I.3}
\]
...
\[
\boxed{\varepsilon_{\text{vac}}(r) = -\frac{\hbar c}{l_0^4} \left( \frac{l_0}{r} \right)^{3-D}} \tag{I.4}
\]
...
\[
Q = -\frac{\hbar^2}{2m} \frac{\nabla^2 \sqrt{\rho}}{\sqrt{\rho}} \tag{I.5}
\]
...
\[
Q(r) \propto \frac{GM(r)}{r} \cdot \frac{1}{c^2} \cdot \left( \frac{l_0}{r} \right)^{(3-D)/2} \tag{I.6}
\]
...
\[
|\nabla Q|^2 \propto \frac{1}{r^4} \cdot \left( \frac{l_0}{r} \right)^{3-D} \tag{I.8}
\]

Die fraktale Modifikation führt zu einer effektiven Skalierung:

\[
\boxed{\sigma(r) = \sigma_0 \cdot r^{D-3}} \tag{I.9}
\]

mit \( \sigma_0 \sim \frac{\hbar c}{l_0^4} \cdot \frac{1}{c^2} \) und \( D-3 \approx -0,296 \).

Die Materieentstehung ist also im Zentrum am stärksten und fällt mit einer
gebrochenen Potenz ab – eine direkte Konsequenz der fraktalen Raumstruktur.
...
\[
z = \frac{1}{c^2} \int_0^d \frac{GM(r)}{r^2} \, dr \tag{I.10}
\]
...
\[
\dot{E}_{\text{Photonen}} = -\frac{d}{dt} \int \varepsilon_{\text{vac}} \, dV \tag{I.11}
\]
...
\[
P_Q = \int \sigma(\vec{r}) c^2 \, dV \tag{I.12}
\]
...
\[
\dot{E}_{\text{Photonen}} + P_Q = 0 \tag{I.13}
\]
...
\[
E_{\text{ges}} = E_{\text{Materie}} + E_{\text{Kinetik}} + E_{\text{Gravitation}} + E_{\text{Vakuum}} \tag{I.14}
\]

Im stationären Zustand gilt:

\[
\frac{dE_{\text{Materie}}}{dt} = -\frac{dE_{\text{Vakuum}}}{dt} \tag{I.15}
\]
...
\label{sub:materieentstehung_eq_vac}

\[
\boxed{\varepsilon_{\text{vac}} = -\frac{\hbar c}{l_0^4} \left( \frac{l_0}{r} \right)^{3-D}} \tag{I.16}
\]

\subsection{Kontinuitätsgleichung mit Quellterm}
\label{sub:materieentstehung_eq_kontinuitaet}

\[
\frac{\partial \rho_m}{\partial t} + \nabla \cdot (\rho_m \vec{v}) = \sigma(\vec{r}) \tag{I.17}
\]

\subsection{Quellterm}
\label{sub:materieentstehung_eq_sigma}

\[
\boxed{\sigma(r) = \sigma_0 \cdot r^{D-3}}, \quad \sigma_0 \sim \frac{\hbar c}{l_0^4 c^2} \tag{I.18}
\]

\subsection{Energieerhaltung}
\label{sub:materieentstehung_eq_energie}

\[
\int \sigma(\vec{r}) c^2 \, dV = -\frac{d}{dt} \int \varepsilon_{\text{vac}}(\vec{r}) \, dV \tag{I.19}
\]
...
\[
v_{\text{drift}}(r) = \sqrt{\frac{GM_{\text{Kern}}}{r}} \cdot \frac{2\dot{r}}{r} \cdot \frac{GM}{c^2 r} \tag{I.20}
\]
...
\[
\alpha_{\text{in}} = \left( \frac{r_c}{r_{\text{max}}} \right)^{3-D} \approx 0,001 \tag{I.21}
\]
...
\[
\frac{dM_{\text{Gal}}}{dt} = \int \sigma(r) \, dV - \dot{M}_{\text{Drift}} = 0 \tag{I.22}
\]
...
Aus (I.18) und der Driftgeschwindigkeit (I.20) folgt das radiale Dichteprofil der
Dunklen Materie (die in der WDBT+ aus Neutrinos besteht, siehe Kapitel~\ref{ch:neutrino}):

\[
\boxed{\rho_{\text{halo}}(r) \propto r^{-0,296}} \tag{I.23}
\]

Dies ist deutlich flacher als das NFW-Profil der ART (\( \rho \propto r^{-1} \) im inneren
Bereich, \( \propto r^{-3} \) im äußeren). Die Vorhersage (I.23) ist mit Beobachtungen
...
\begin{enumerate}
    \item \textbf{Bestimmung von \( \kappa \):} Die dimensionslose Konstante in (I.7)
          sollte aus der fraktalen Geometrie folgen.
    
    \item \textbf{Quantisierung:} Die hier präsentierte klassische Beschreibung muss
          quantisiert werden.
    
    \item \textbf{Stabilität des Grenzzyklus:} Ist der stationäre Zustand global attraktiv?
\end{enumerate}

Dennoch liefert der vorliegende Anhang die konzeptionelle Grundlage für die
Materieentstehung in der stationären Kosmologie der WDBT+.