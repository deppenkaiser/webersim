...
\label{app:entropie_axiome}

\subsection{Axiom 1: Fraktale Raumstruktur}
\label{app:entropie_axiom1}
...
\label{app:entropie_axiom5}

Die Weber-Gravitation mit $\beta_{\text{WG}} = 0,5$ (siehe Kapitel~\ref{ch:dstt_weber}) führt zu einer monotonen Zunahme 
...
\label{app:entropie_fluesse}

\subsection{Kontinuitätsgleichung der fraktalen Entropie}
\label{app:entropie_kontinuitaet}
...
\label{app:entropie_identifikation}
...
\label{app:entropie_kreislauf}

\subsection{Darstellung des Kreislaufs}
\label{app:entropie_kreislauf_darstellung}
...
\label{app:entropie_waermetod}

\subsection{Bedingungen für einen Wärmetod}
\label{app:entropie_waermetod_bedingungen}
...
\label{app:entropie_verhinderung}
...
\begin{itemize}
    \item Der Raum expandiert nicht, aber Strukturen und Bahnen dehnen sich durch die 
          DSTT-Drift aus.
    \item Die mittlere Dichte bleibt durch kontinuierliche Materieentstehung (Anhang~\ref{app:energiebilanz}) konstant.
...
die intrinsische Irreversibilität der Gravitation selbst (siehe Kapitel~\ref{ch:dstt_weber}).

\section{Zusammenfassung}
\label{app:entropie_zusammenfassung}
