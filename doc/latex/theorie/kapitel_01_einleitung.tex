...
\item \textbf{Hubble-Spannung erklärt:} Die effektive Hubble-Konstante ist skalenabhängig (siehe Kapitel~\ref{ch:kosmologie}, Abschnitt~\ref{sec:effektive_hubble}): \(H_{\text{eff}}(d) \propto d^{0,704}\).
