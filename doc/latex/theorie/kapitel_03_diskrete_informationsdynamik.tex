...
\label{ch:diskrete_dynamik}

\section{Der diskrete Informationszustand}
\label{sec:diskreter_zustand}
...
\label{sec:informationserhaltung}
...
\label{sec:dynamik_informationsfluss}
...
\label{sec:diskrete_weber_kraft}
...
Diese digitale Theorie besitzt kein vorgegebenes Raummodell. Der Raum emergiert aus der Kopplungsstruktur \( K_{kl}^{(n)} \) (siehe Kapitel~\ref{ch:emergenz}).
