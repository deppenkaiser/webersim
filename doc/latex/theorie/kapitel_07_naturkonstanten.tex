...
Diese Parameter sind dimensionslos (bis auf \( \lambda_0 \) und \( T \), die eine absolute Skala setzen). Sie sind die \enquote{Schrauben} der Theorie – aber sie sind nicht frei. Sie werden durch die beobachtbaren Konstanten der WDBT+ eindeutig festgelegt.
...
\label{sec:nu_relation}

Die Neutrinomasse folgt aus der fundamentalen Länge (siehe Kapitel~\ref{ch:neutrino}):
