...
Die reine Weber-Gravitation (WG) ist für sich genommen unvollständig. Sie produziert in zweiter Ordnung der Störungsrechnung einen störenden Term, der zu nicht-geschlossenen Bahnen führen würde. Die vollständige Theorie ist die \textbf{Weber-De-Broglie-Bohm-Theorie (WDBT)}. In ihr wird die Kraft um das Quantenpotential \(Q\) der De-Broglie-Bohm-Theorie erweitert.
...
Der Grund ist ein störender Term \( \alpha\phi^2 \) in der Bahngleichung zweiter Ordnung. Dieser Term wird jedoch durch das Quantenpotential \( Q \) \textbf{exakt} kompensiert (siehe Anhang~\ref{app:identitaet}). Daher gilt die exakte Identität für die vollständige WDBT.
...
\begin{itemize}
    ...
    \item Die Identitätsbeziehung \( \frac{|\vec{F}_{\text{WDBT}}^{\text{tan}}|}{|\vec{F}_{\text{WDBT}}^{\text{rad}}| + |\vec{F}_{\text{WDBT}}^{\text{tan}}|} \equiv \beta_{\text{DSTT}} \) gilt exakt.
