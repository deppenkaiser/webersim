...
Die DSTT-Zustandsvariable \( \beta_{\text{DSTT}} \) und die Terme der Weber-Kraft sind über eine Identitätsbeziehung verknüpft (siehe auch Anhang~\ref{app:identitaet}):
...
\noindent
\textbf{Gültigkeitsbereich:} Sei \( \mathcal{D} \) die Menge aller Phasenraumpunkte, für die die Radialgeschwindigkeit \( \dot{r} \neq 0 \) ist.
