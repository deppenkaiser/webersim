% ============================================================================
% KAPITEL 13: Theorie der fraktalen Entropie
% ============================================================================
...
\begin{itemize}
    \item \( \sigma_{\text{cre}} > 0 \): Entropiefluss von Vakuum zu gravitativer Materie (Materieentstehung durch Quantenpotential, siehe Anhang~\ref{app:materieentstehung})
...
\label{sub:entropie_waermetod_bedingungen}
...
\label{sub:entropie_verhinderung}
...
\begin{itemize}
    ...
    \item Die mittlere Dichte bleibt durch kontinuierliche Materieentstehung konstant (siehe Anhang~\ref{app:materieentstehung}).
