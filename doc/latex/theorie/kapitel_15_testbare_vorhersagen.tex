...
Dies ist mit zukünftigen Detektoren wie LISA oder dem Einstein-Teleskop testbar.
...
\text{Gravitationswellen-Dispersion} & v_{\text{phase}}(\omega) = c(1 + \alpha \omega^{-0,099}) & \text{LISA, Einstein-Teleskop} \\
