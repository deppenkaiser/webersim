...
voraus, direkt aus der fundamentalen Länge \( l_0 \). Dies ist mit Experimenten wie KATRIN (\cite{KATRIN2022}) oder dem neutrinolosen Doppelbeta-Zerfall testbar.
...
Dies weicht von den Vorhersagen des Standardmodells ab und ist mit Neutrino-Oszillationsexperimenten (JUNO, DUNE, Hyper-Kamiokande) testbar (siehe auch Anhang~\ref{app:neutrino_oszillation}).
...
\( \dot{\rho}_{\text{cre}}(r) \propto r^{D-3} = r^{-0,296} \) (siehe Anhang~\ref{app:materieentstehung}). 
