...
Sie folgt aus Dodekaeder-Geometrie und Fibonacci-Rekursion. Die fraktale Struktur des Raumes wird nicht durch fraktale Differentialoperatoren beschrieben,
sondern durch die spektrale Dimension (siehe Anhang~\ref{app:spektrale_dimension}) und fraktale Skalierung in den Quelltermen (siehe Kapitel~\ref{ch:fraktale_maxwell}).
