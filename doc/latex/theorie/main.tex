...
Dieses Buch ist keine abgeschlossene Theorie. Es ist eine \textbf{Arbeitsgrundlage}. 
Die fraktale Mathematik ist nicht vollständig ausgearbeitet. Die quantitativen Vorhersagen 
sind nicht bis zur letzten Nachkommastelle gerechnet. Dies ist ein \textbf{Neuansatz}, 
kein Endpunkt.

Wer dieses Buch mit den Maßstäben der etablierten Theorien (ART, Quantenmechanik, 
Standardmodell) misst, begeht einen Kategorienfehler. Die etablierten Theorien haben 
hunderttausende Mannstunden an Entwicklung hinter sich – dieses Buch ist nach zwei Jahren 
Einzelarbeit entstanden. Die Frage ist nicht: „Stimmt es mit der ART überein?“ 
Sondern: „Funktioniert es?“ – und: „Macht es Vorhersagen, die die etablierten Theorien 
nicht machen?“
...
\input{anhang_e_fraktal}
\input{anhang_f_kontinuumslimes}
\input{anhang_g_identitaetsbeziehung}
\input{anhang_h_periheldrehung}
\input{anhang_i_omega}
\input{anhang_j_materie}
\input{anhang_k_neutrino}
\input{anhang_l_bec}
\input{anhang_m_entropie}
