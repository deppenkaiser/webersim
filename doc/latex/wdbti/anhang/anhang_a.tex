...
\section{Einleitung}
Dieser Anhang stellt die mathematischen Werkzeuge bereit, auf denen die diskrete Formulierung der Informations-Weber-Theorie basiert. Im Gegensatz zu den kontinuierlichen
...
Ein diskretes Informationssystem wird beschrieben durch Knoten $k = 1, \ldots, N$ mit Informationswerten $I_k^{(n)}$ zum Zeitschritt $n$. Das fundamentale diskrete Funktional lautet:
\[
...
\subsection{Beispiel: Fraktales Netz mit $D \approx 2.71$}
...
Die diskrete Informations-Weber-Theorie basiert auf folgenden mathematischen Grundlagen:
