...
\section{Einleitung}
Dieser Anhang präsentiert mathematisch vollständige und rigorose Herleitungen aller wesentlichen Gleichungen der Informations-Weber-Theorie (IWT). Im Gegensatz zur oft
verkürzten Darstellung im Haupttext werden hier alle Schritte explizit ausgeführt und alle Annahmen klar benannt. Die Herleitungen basieren konsequent auf den diskreten
Grundgleichungen der IWT.
...
\hline
Diskrete Einstein-Gleichungen & Variation diskreter Hilbert-Wirkung & Reproduziert ART im Grenzfall \\
\hline
...
\hline
Diskrete Schrödinger-Gleichung & Variation komplexen Funktionals & Reproduziert QM im Kontinuumslimes \\
\hline
...
\begin{enumerate}
    \item Alle wesentlichen Gleichungen der IWT lassen sich rigoros aus diskreten Prinzipien herleiten
...
Diese vollständigen Herleitungen belegen die mathematische Solidität der Informations-Weber-Theorie und ermöglichen ihre kritische Überprüfung durch die wissenschaftliche
Gemeinschaft.
