...
Die Kombination aus fraktaler Raumstruktur der \gls{iwt} und der Driftgleichung der \gls{dstt} führt zu einem statischen, aber dynamisch strukturierten Universum. Die wichtigsten
Konsequenzen sind:
...
\caption{Vergleich der drei fundamentalen Orbit-Typen: 
Newton (geschlossen), WDBT (präzedierend, gebunden), DSTT (Spirale mit Drift).}
\end{figure}
