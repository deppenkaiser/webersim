...
\end{aligned}
\]
wobei $\mathbf{J}_g = \rho_{\mathrm{eff}} \mathbf{v}$ der effektive Massenstrom ist. Diese Gleichungen sind \textbf{emergent}; sie beschreiben die makroskopische Gravitation als effektive Feldtheorie, die aus der diskreten Informationsdynamik der \gls{iwt} hervorgeht.
