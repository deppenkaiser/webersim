...
\section{Einleitung}
Die Informations-Weber-Theorie liefert eine alternative kosmologische Struktur, die ohne Urknall, ohne Dunkle Materie und ohne Dunkle Energie auskommt. Statt eines
expandierenden Raumes beschreibt sie das Universum als dynamisches Informationsnetz, dessen fraktale Geometrie und Kopplungsstruktur die beobachteten kosmologischen
...
Die kosmische Hintergrundstrahlung (CMB) wird in der Standardkosmologie als thermisches Relikt des Urknalls interpretiert. In der Informations-Weber-Theorie ist sie die
fossilierte Struktur der frühen Informationsgeometrie eines großskaligen Plasmas.
...
\begin{itemize}
    ...
    \item die Homogenität und Isotropie aus systemischer Ganzheit folgen,
...
Die beobachtete Rotverschiebung entsteht ohne:
\begin{itemize}
...
\end{itemize}
Damit wird Dunkle Materie überflüssig.
...
\end{itemize}
Diese Strukturen entstehen nicht aus Gravitationsinstabilitäten, sondern aus:
\begin{itemize}
    \item fraktaler Kopplung,
...
\begin{itemize}
    ...
    \item Die CMB-Struktur ist eine fossilierte Informationsgeometrie.
