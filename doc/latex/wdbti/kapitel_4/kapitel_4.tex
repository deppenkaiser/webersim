...
Das Informations-Lagrange-Funktional ersetzt:
\begin{itemize}
    \item die Newtonsche Bewegungsgleichung,
    \item die Maxwell-Gleichungen,
    \item die Schrödinger-Gleichung,
    \item die Feldgleichungen der ART.
\end{itemize}
Es bildet die mathematische Grundlage der gesamten Theorie.
...
\]
Damit ist $Q$ kein Zusatz der Quantenmechanik, sondern der globale Anteil der
Informationsdynamik.
...
\end{itemize}
Beide entstehen aus demselben Funktional — sie sind keine unabhängigen Modelle.
