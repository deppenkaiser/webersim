...
In der klassischen Physik ist Trägheit eine\\primitive Eigenschaft der Materie.
In der Informations-Weber-Theorie entsteht Trägheit aus der Reaktion der Informationsstruktur auf zeitliche Änderungen.
\begin{itemize}
...
Die Informations-Weber-Theorie beschreibt Gravitation als \emph{Informationsfluss}.
...
\end{itemize}
Die systemische Kausalität ist nicht durch Lichtgeschwindigkeit begrenzt, da sie keine Energie transportiert. Sie erzeugt die Nichtlokalität der \gls{qm}, ohne die
...
\section{Emergenz der QM}
Die \gls{qm} entsteht als Grenzfall starker globaler Informationsorganisation. In diesem Regime gilt:
\begin{itemize}
...
\begin{itemize}
    ...
    \item Die klassische Mechanik, die \gls{qm} und die Relativitätstheorie sind Grenzfälle derselben fundamentalen Informationsordnung.
\end{itemize}
