...
\section{Das Plancksche Wirkungsquantum als Maß der Informationsgranularität}
...
\]
beschreibt die systemische Organisation des Informationszustands. Die Größe $\hbar$ bestimmt die Stärke dieser globalen Kopplung.
...
Die Gravitationskonstante $G$ entsteht aus der Kopplungsstruktur des Informationsnetzes, insbesondere aus der fraktalen Geometrie der Masseverteilung.
...
\[
    ...
    \right).
\]
In der Informations-Weber-Theorie ist $G$ kein unabhängiger Parameter, sondern eine Konsequenz der Kopplungsstärke des Informationsnetzes:
\[
    G \propto \lambda^{3-D}.
\]
