...
\begin{itemize}
    ...
    \item Die Quantenmechanik entsteht als globaler Grenzfall der Informationsdynamik.
\end{itemize}
...
Die Weber-Gravitation besitzt die Form:
\[
    F_{\text{WG}}
    =
    -G \frac{m_1 m_2}{r^2}
    ...
    \right).
\]
In der Informations-Weber-Theorie ist $G$ kein unabhängiger Parameter, sondern:
\[
    G \propto \lambda^{3-D}.
\]
...
\begin{itemize}
    ...
    \item Gravitation ist eine Konsequenz der fraktalen Kopplungsstruktur.
    \item $G$ ist skalenabhängig und nicht fundamental.
\end{itemize}
