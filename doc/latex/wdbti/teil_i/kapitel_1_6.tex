...
Die diskrete \gls{iwt} beschreibt physikalische Systeme nicht durch Felder, Teilchen oder eine ontologische Raumzeit, sondern durch die Struktur und
...
In der klassischen Physik ist Trägheit eine primitive Eigenschaft der Materie. In der diskreten Informations-Weber-Theorie entsteht Trägheit aus der Reaktion der diskreten
...
Die \gls{art} beschreibt Gravitation als Krümmung der Raumzeit. Die diskrete \gls{iwt} beschreibt Gravitation als \emph{diskreten Informationsfluss}.
...
\section{Emergenz der \gls{qm} im diskreten Grenzfall}
Die \gls{qm} entsteht als Grenzfall starker globaler diskreter Informationsorganisation.
...
\end{itemize}
Die diskrete \gls{iwt} vereinheitlicht damit klassische Mechanik, \gls{qm} und Relativitätstheorie als verschiedene Grenzfälle derselben fundamentalen diskreten
Informationsdynamik.
