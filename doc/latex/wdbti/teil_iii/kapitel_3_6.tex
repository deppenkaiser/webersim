\section{Herleitung der \gls{cmb}-Gleichgewichtstemperatur}

\subsection{Energieverlust durch Rotverschiebung}
...
\subsection{Heizleistung des kosmischen Photonengases}
...
\subsection{Thermische Abstrahlung des Plasmas}
...
\subsection{Gleichgewicht und \gls{cmb}-Temperatur}
...
\[
T_{\mathrm{\gls{cmb}}} \approx 2.7\,\mathrm{K}.
\]
...
\subsection{Fazit}
Die in diesem Abschnitt hergeleitete Gleichgewichtstemperatur des kosmischen Photonengases zeigt, dass ein extrem schwacher, aber nicht verschwindender Energieaustausch
...
verworfen wird, sondern eine natürliche Konsequenz realer Plasmaeigenschaften: endliche Emissivität, große effektive Oberfläche und nicht-verschwindende optische Tiefe über
...
Die fraktale Kosmologie liefert die kosmischen Parameter \(\gamma_{\mathrm{eff}}\), \(\rho_{\mathrm{eff}}\) und \(L\) und damit die mittlere Verlustkonstante \(\bar{\alpha}(L)\) rein theoretisch. Der beobachtete Wert der CMB-Temperatur fixiert anschließend die kombinierte Plasmaparametergröße
\[
...
Damit ergibt sich ein klarer Schluss: Die \gls{cmb}-Temperatur ist kein Relikt eines Urknalls, sondern das Ergebnis eines stationären Gleichgewichts zwischen kosmischer
...
konsistent und folgt direkt aus der \gls{iwt} des Universums.
