...
\include{teil_ii/kapitel_2_1}
\include{teil_ii/kapitel_2_2}

\setcounter{chapter}{0}
\part{EXPERIMENTELLE VORHERSAGEN}
\include{teil_iii/kapitel_3_2}
\include{teil_iii/kapitel_3_3}
\include{teil_iii/kapitel_3_4}

\stepcounter{chapter}{0}
\part{ANHANG}
\appendix
\include{anhang/anhang_a}
\include{anhang/anhang_b}
\include{anhang/anhang_c}
\include{anhang/anhang_d}
\include{anhang/anhang_e}
