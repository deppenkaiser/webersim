...
\input{content/08_r_phi}
\input{content/10_1_w_phi}
\input{content/10_2_v_phi}
\chapter{Instantane Energieverteilung und Kausalität}
\input{content/12_kausal}
\chapter{Sonnensystem}
\label{chapter:sonnensystem}
\input{content/19_perihel}
\input{content/20_T}
\input{content/22_lichtablenkung}
\chapter{WG-DBT Synthese}
\input{content/24_wg_dbt_synthese}
\part{Kosmologie}
\input{content/31_rotverschiebung}
\input{content/32_shapiro}
\input{content/33_wg_dbt_konsequenzen}
\part{Anhang}
\chapter{Diskussionen}
\label{chapter:diskussion}
\input{content/37_dodekaeder}
