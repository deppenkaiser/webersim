...
\input{content/09_weber_kraft_em}
\input{content/10_grundgleichungen}
\input{content/11_r_phi}
\input{content/14_1_w_phi}
\input{content/14_2_v_phi}
\chapter{Sonnensystem}
\label{chapter:sonnensystem}
\input{content/15_perihel}
\input{content/16_T}
\input{content/18_lichtablenkung}
\chapter{WG-DBT Synthese}
\input{content/19_wg_dbt_synthese}
\part{Kosmologie}
\input{content/21_DM}
\input{content/22_rotverschiebung}
\input{content/23_shapiro}
\part{Anhang}
\chapter{Diskussionen}
\label{chapter:diskussion}
\input{content/28_welle}
\input{content/30_konsequenzen_rotverschiebung}
\input{content/31_bohm}
\input{content/38_kausal_0}
\input{content/38_kausal_1}
\input{content/38_kausal_2}
\input{content/38_kausal_3}
\input{content/38_kausal_4}
\input{content/38_kausal_5}
\input{content/38_kausal_6}
\chapter{Quantengravitation}
\input{content/39_dodekaeder}
\input{content/40_dodekaeder_emergenz}
\input{content/41_dodekaeder_renormierung}
\input{content/42_dodekaeder_art}
\input{content/43_dodekaeder_manifest}
\input{content/44_dodekaeder_qg_schritte}
